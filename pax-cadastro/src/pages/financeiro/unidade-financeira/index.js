...
const fornecedoresData = [
  createData("Caixa Econômica", "Ativo"),
  createData("Banco do Brasil", "Ativo"),
  createData("Santander", "Ativo"),
];
    ...
    <div className="container-cadastro">
      ...
      <div className="sub-container-cadastro">
        <div className="pesquisa-tabelas-cadastro">
          ...
          <ModalEdicao
            titulo="Editar Unidade Financeira"
        ...
        <div className="tabelas-cadastro-usuarios">
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              <TableHead>
                <TableRow>
                  <TableCell>Unidade Financeira</TableCell>
...
export default UnidadeFinanceira;
