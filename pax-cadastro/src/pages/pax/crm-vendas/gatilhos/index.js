...
function createData(name, coluna, status, opcoes) {
  return { name, coluna, status, opcoes };
}

const funcaoData = [
  createData("Oportunidade ganha", "Venda Finalizada", "Ativo"),
  createData("Agendamentos", "Negados", "Ativo"),
  createData("Oportunidade arquivada", "Oportunidade de Venda", "Ativo"),
];
    ...
    <div className="container-cadastro">
      ...
      <div className="sub-container-cadastro">
        <div className="pesquisa-tabelas-cadastro">
          ...
          <ModalEdicao titulo="Editar Gatilho" isOpen={modalEdicaoOpen} onClose={handleCloseModalEdicao}>
            <div className="linhas-campos-cadastro">
            <div className="tipo-raca-cadas">
                <label>Gatilho</label>
                <input></input>
            ...
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="start">Coluna de Destino</TableCell>
              ...
              <TableBody>
                {funcaoEstado.map((row, index) => (
                  ...
                  >
                    ...
                    <TableCell align="start">{row.coluna}</TableCell>
