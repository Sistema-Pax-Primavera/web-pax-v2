...
const funcaoData = [
  createData("Prospecção Externa", "Ativo"),
  createData("Indicação - Cobrador", "Ativo"),
  createData("SAC", "Ativo"),
];
    ...
    <div className="container-cadastro">
      ...
      <div className="sub-container-cadastro">
        <div className="pesquisa-tabelas-cadastro">
          ...
          <ModalEdicao
            titulo="Cadastrar Origem das Leads"
          ...
          <ModalEdicao titulo="Editar Origem das Leads" isOpen={modalEdicaoOpen} onClose={handleCloseModalEdicao}>
            <div className="linhas-campos-cadastro">
              <div className="tipo-raca-cadas">
                <label>Origem do Lead</label>
                <input></input>
        ...
        <div className="tabelas-cadastro-usuarios">
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              <TableHead>
                <TableRow>
                  <TableCell>Origem das Leads</TableCell>
