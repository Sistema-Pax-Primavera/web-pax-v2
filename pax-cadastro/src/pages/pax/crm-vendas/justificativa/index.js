...
const funcaoData = [
  createData("Cliente Não Deu Abertura Para Falar", "Ativo"),
  createData("Enviado para Unidade Atender", "Ativo"),
  createData("Idade Acima de 65 Anos", "Ativo"),
];
    ...
    <div className="container-cadastro">
      ...
      <div className="sub-container-cadastro">
        <div className="pesquisa-tabelas-cadastro">
          ...
          <ModalEdicao
            titulo="Cadastrar Justificativa"
          ...
          <ModalEdicao titulo="Editar Justificativa" isOpen={modalEdicaoOpen} onClose={handleCloseModalEdicao}>
            <div className="linhas-campos-cadastro">
              <div className="tipo-raca-cadas">
                <label>Justificativa</label>
                <input></input>
