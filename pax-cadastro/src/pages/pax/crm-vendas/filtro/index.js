...
const funcaoData = [
  createData("Clientes a Ligar", "Ativo"),
  createData("Agendamentos do Dia", "Ativo"),
    ...
    <div className="container-cadastro">
      ...
      <div className="sub-container-cadastro">
        <div className="pesquisa-tabelas-cadastro">
          ...
          <ModalEdicao titulo="Editar Filtro" isOpen={modalEdicaoOpen} onClose={handleCloseModalEdicao}>
            <div className="linhas-campos-cadastro">
              <div className="tipo-raca-cadas">
                <label>Filtro</label>
                <input></input>
