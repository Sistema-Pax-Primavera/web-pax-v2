...
function createData(name, setor, status, opcoes) {
  return { name, setor, status, opcoes };
}

const funcaoData = [
  createData("Transferência de CRM", "Televendas", "Ativo"),
  createData("Prospecção Sauer", "SAC", "Ativo"),
  createData("Samuel Ortega", "Televendas", "Ativo"),
];
            ...
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="start">Setor</TableCell>
              ...
              <TableBody>
                {funcaoEstado.map((row, index) => (
                  ...
                  >
                    ...
                    <TableCell align="start">{row.setor}</TableCell>
