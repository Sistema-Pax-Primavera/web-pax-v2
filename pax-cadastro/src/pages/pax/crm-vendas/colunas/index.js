...
function createData(name, filtro, status, opcoes) {
  return { name, filtro, status, opcoes };
}

const funcaoData = [
  createData("1ª Parcela em atraso", "Agendamento do dia","Ativo"),
  createData("2ª Parcela em atraso", "Categoria F9", "Ativo"),
  createData("3ª Parcela em atraso", "Recusados","Ativo"),
];
    ...
    <div className="container-cadastro">
      ...
      <div className="sub-container-cadastro">
        <div className="pesquisa-tabelas-cadastro">
          ...
          <ModalEdicao titulo="Editar Colunas" isOpen={modalEdicaoOpen} onClose={handleCloseModalEdicao}>
            <div className="linhas-campos-cadastro">
            <div className="tipo-raca-cadas">
                <label>Coluna</label>
                <input></input>
            ...
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="start">Filtro</TableCell>
              ...
              <TableBody>
                {funcaoEstado.map((row, index) => (
                  ...
                  >
                    ...
                    <TableCell align="start">{row.filtro}</TableCell>
