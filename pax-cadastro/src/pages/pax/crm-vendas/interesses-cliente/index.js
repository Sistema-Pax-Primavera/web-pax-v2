...
const funcaoData = [
  createData("Plano Novo ", "Ativo"),
  createData("Pet", "Ativo"),
  createData("Estetica", "Ativo"),
];
    ...
    <div className="container-cadastro">
      ...
      <div className="sub-container-cadastro">
        <div className="pesquisa-tabelas-cadastro">
          ...
          <ModalEdicao titulo="Editar Interesses do Cliente" isOpen={modalEdicaoOpen} onClose={handleCloseModalEdicao}>
            <div className="linhas-campos-cadastro">
              <div className="tipo-raca-cadas">
                <label>Interesses do Cliente</label>
                <input></input>
        ...
        <div className="tabelas-cadastro-usuarios">
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              <TableHead>
                <TableRow>
                  <TableCell>Interesses do Cliente</TableCell>
...
export default InteressesCLiente;
