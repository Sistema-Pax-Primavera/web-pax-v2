...
function createData(name, cor, status, opcoes) {
  return { name, cor, status, opcoes };
}

const funcaoData = [
  createData("Academia", "gray", "Ativo"),
  createData("Consultas", "red", "Ativo"),
  createData("Cremação", "green", "Ativo"),
];
